        ...
        <ul class="nav" id="side-menu">
            <li class="user-pro">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="{{ route('mails.index', 0) }}"><i class="ti-email"></i> الوارد</a></li>
                    <li><a href="{{ route('setting.index') }}"><i class="ti-settings"></i> الاعدادات</a></li>
                    <li>
            ...
            <li class="nav-small-cap m-t-10"> القائمة </li>
            ...
            <li>
              <a href="{{ route('captins.index') }}" class="waves-effect">
                <i class="fa fa-users fa-fw"></i>
                <span class="hide-menu"> {{ __('lang.captins') }} </span>
              </a>
            </li>
