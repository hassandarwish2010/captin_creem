      ...
      <div class="white-box">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="ar_name" placeholder="{{ __('lang.ar_name') }}" name="ar_name" value="@if(old('ar_name') != null){{ old('ar_name') }}@elseif(isset($about)){{$about->ar_name}}@endif" required="required">
            </div>
            <div class="input-group">
      ...
      <div class="white-box">
          <div class="row">
              <div class="col-sm-12 col-xs-12">
                ...
                <textarea id="editor1" name="ar_details" rows="8" class="form-control" style="resize:vertical;width:100%;" placeholder="{{ __('lang.ar_details') }}">@if(old('ar_details') != null){{ old('ar_details') }}@elseif(isset($about->ar_details)){{$about->ar_details}}@endif</textarea>
